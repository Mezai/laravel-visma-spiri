...
namespace Mezai\Visma\Exceptions;
...
class InvalidConfiguration extends Exception
{
    ...
    {
        return new static('Missing client ID. To use the Visma API you need to set a valid client ID.');
    }

    public static function missingClientSecret(): self
    {
        return new static('Missing client secret. To use the Visma API you need to set a valid client secret.');
    }

    public static function missingBaseUrl(): self
    {
        return new static('Missing Fornox Base URL. To use the Visma API you need a non-empty base URL set.');
    }
